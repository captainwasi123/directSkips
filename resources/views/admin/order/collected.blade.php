...
@section('title', 'Collected | Orders')
@section('page_title', 'Collected | Orders')
@section('content')
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Collected Orders</h4>
                                <hr>
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
	                                                      ...
	                                                      <div class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item changeState" href="javascript:void(0)" data-href="{{URL::to('/admin/orders/status/5/'.base64_encode($data->id))}}">Archive</a>
	                                                      </div>
	                                                    </div>
                                                    </td>
	                                            </tr>
                                            ...
                                            @endif
                                                <tr>
                                                    <td colspan="15">{{ $databelt->links() }}</td>
                                                </tr>
                                        </tbody>
                                    </table>
                                </div>
