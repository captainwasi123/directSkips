...
<div class="container">
      ...
      <div class="col-md-6">
        <div class="jumbotron text-center">
          <div class="row">
            <div class="col-md-6">
              <img src="{{URL::to('/')}}/assets/web/images/logo.png" class="payment-logo">
            </div>
            <div class="col-md-6">
              <img src="{{URL::to('/')}}/assets/web/images/stripe.png" class="stripe-logo">
            </div>
            <div class="col-md-12">
              <hr>
            ...
            .then((data) => {
                ...
                .then(function(result){
                    if(result.error){
                        ...
                        xhttp.open("GET", "{{URL::to('/order/confirmed/'.$id)}}", true);
                        xhttp.send();
